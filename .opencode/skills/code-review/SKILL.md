---
name: code-review
description: Multi-agent code review for local changes, files, or directories. Detects bugs, security issues, and conventions-file violations (AGENTS.md/CLAUDE.md/GEMINI.md). Use when reviewing code changes, PRs, or specific files.
---
