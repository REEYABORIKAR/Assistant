---
name: mobile-design
description: Mobile-first design and engineering doctrine for iOS and Android apps. Covers touch interaction, performance, platform conventions, offline behavior, and mobile-specific decision-making. Use for React Native, Flutter, or native mobile apps.
---
...
## 3. AI Mobile Anti-Patterns (Hard Bans)
...
## 4. Platform Unification vs Divergence Matrix
...
## 5. Mobile UX Psychology (Non-Optional)
...
## 7. Framework Decision Tree (Canonical)
