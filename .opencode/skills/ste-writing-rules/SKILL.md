---
name: ste-writing-rules
description: ASD-STE100 writing rules summary — word choice, verb forms, voice, sentence structure, paragraph structure, safety instructions. Use when writing documentation, README files, procedures, or any technical explanation that must be clear and unambiguous.
---
...
## Why STE Matters for Agent Output
