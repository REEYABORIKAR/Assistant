...
description: Simplifies and refines code for clarity, consistency, and maintainability while preserving all functionality. Works on recently modified code, a set of changes, or the whole codebase. Use when refactoring, cleaning up code, or improving readability.
---
...
3. Apply project-specific best practices from AGENTS.md or similar conventions files
