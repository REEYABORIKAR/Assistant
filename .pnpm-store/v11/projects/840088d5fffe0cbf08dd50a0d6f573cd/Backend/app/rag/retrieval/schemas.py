...
class SearchResult(BaseModel):
    ...
    rerank_score: Optional[float] = None   # Cross-encoder logit, when reranking ran
...
class RetrievalMetadata(BaseModel):
    ...
    expanded_query: Optional[str] = None   # Populated when query expansion ran
...
class GenerateResponse(BaseModel):
    ...
    message: Optional[str] = None            # Human-readable status when generation is unavailable
    citations: List[Citation] = []
